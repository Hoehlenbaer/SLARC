...
------------------------------------------------------------
RESPONSE FORMAT
<thinkl>One sentence reasoning</think>
...
def stream_and_capture(llm, messages):
    ...
    stream = llm.create_chat_completion(messages=messages, max_tokens=512, temperature=0.7, min_p = 0.00, top_p = 0.80, top_k = 20, presence_penalty = 1.0, stream=True)
